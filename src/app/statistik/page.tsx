...
export default function StatisticsPage() {
  ...
  return (
    <main className="flex min-h-screen flex-col bg-slate-50">
      {/* ====================================================== */}
      {/* HERO SECTION (Image Background + Black Overlay) */}
      {/* ====================================================== */}
      <section className="relative flex min-h-[70vh] items-center justify-center overflow-hidden">
        ...
        <div
          ...
          style={{
            backgroundImage: "url('/images/hero4.webp')", // Silakan ganti gambar sesuai kebutuhan
          }}
        />

        {/* Overlay Hitam Transparan (Tidak Mencolok & Elegan) */}
        ...
        <div className="relative z-10 mx-auto max-w-4xl px-6 text-center text-white">
          ...
          <p className="mx-auto max-w-3xl text-lg leading-8 text-gray-200 md:text-xl">
            Data demografi, luas wilayah, dan informasi potensi kependudukan
            terkini di wilayah Dusun II, Desa Kecemen.
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="mb-12 text-center">
            ...
            <p className="mt-4 text-gray-600">
              Angka penting kependudukan Dusun II tahun ini
            </p>
          </div>
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {stats.map((stat) => {
              ...
              return (
                <div
                  key={stat.id}
                  className="relative overflow-hidden rounded-2xl bg-white p-8 shadow-sm ring-1 ring-gray-100 transition-all hover:shadow-md hover:-translate-y-1"
                >
          ...
          <div className="grid gap-16 md:grid-cols-2 items-center">
            ...
            <div>
              ...
              <p className="text-gray-600 mb-8 leading-relaxed">
                Penduduk Dusun II memiliki persebaran gender yang relatif
                seimbang. Hal ini mendukung produktivitas kelompok tani dan
                kegiatan sosial kemasyarakatan yang optimal.
              </p>
            ...
            <div className="bg-emerald-50 rounded-3xl p-8 border border-emerald-100 shadow-sm relative overflow-hidden">
              ...
              <p className="text-gray-600 text-base leading-relaxed mb-8 relative z-10">
                Terdapat peningkatan jumlah kepala keluarga sebesar 2.5%
                dibandingkan tahun sebelumnya, yang sebagian besar didominasi
                oleh keluarga muda yang menetap di perbatasan wilayah desa.
              </p>
              <div className="bg-white p-5 rounded-2xl border border-emerald-100 text-center relative z-10">
                <span className="block text-4xl font-extrabold text-emerald-600 mb-2">
                  +2.5%
                </span>
                <span className="text-sm font-bold text-gray-500 uppercase tracking-widest">
                  Pertumbuhan KK per Tahun
                </span>
              </div>
            </div>
          </div>
      ...
      {/* <section className="bg-emerald-700 py-24 text-white">
        <div className="mx-auto max-w-4xl px-6 text-center">
          ...
          <p className="mb-10 text-lg leading-8 text-emerald-100 max-w-2xl mx-auto">
            Punya pertanyaan atau butuh informasi spesifik lainnya terkait data
            statistik, demografi, maupun potensi wilayah Desa Kecemen?
          </p>
          <Button
            size="lg"
